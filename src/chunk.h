...
typedef enum {
    ...
    VM_METHOD_STRING_ISSPACE, VM_METHOD_STRING_CONTAINS, VM_METHOD_STRING_BEFORE, VM_METHOD_STRING_AFTER,
    VM_METHOD_STRING_REVERSE, VM_METHOD_STRING_WORDS,
    VM_METHOD_ARRAY_ADD, VM_METHOD_ARRAY_POP, VM_METHOD_ARRAY_SORT, VM_METHOD_ARRAY_INSERT, VM_METHOD_ARRAY_REMOVE,
    VM_METHOD_ARRAY_EXTEND, VM_METHOD_ARRAY_LEN, VM_METHOD_ARRAY_REVERSE, VM_METHOD_ARRAY_COUNT,
    VM_METHOD_ARRAY_INDEX, VM_METHOD_ARRAY_CLEAR, VM_METHOD_ARRAY_CONTAINS,
    VM_METHOD_DICT_KEYS, VM_METHOD_DICT_VALUES, VM_METHOD_DICT_ITEMS,
    VM_METHOD_DICT_ERASE, VM_METHOD_DICT_GET, VM_METHOD_DICT_HAS, VM_METHOD_DICT_REMOVE, VM_METHOD_DICT_CLEAR,
    VM_METHOD_SET_ADD, VM_METHOD_SET_REMOVE, VM_METHOD_SET_DISCARD,
