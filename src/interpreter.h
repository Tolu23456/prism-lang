...
typedef struct { Env *globals; int had_error; char error_msg[2048]; Value return_val; bool returning, breaking, continuing; PrismGC *gc; const char *filename; } Interpreter;
